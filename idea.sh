...
find ~/Library/Application\ Support/JetBrains -maxdepth 1 -type d -name 'IntelliJIdea*' 2> /dev/null | while read file; do updateSymlink "$file"; done
find ~/Library/Application\ Support/JetBrains -maxdepth 1 -type d -name 'Idea*' 2> /dev/null | while read file; do updateSymlink "$file"; done
